...
import BlockUnblockButton from "../buttons/BlockUnblockButton";
const ViewProfile = () => {
  ...
  const getFollowers = async () => {
    try {
      const res = await axios.get(
        `${API_URL}/api/follow/list/following/${username}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getFollowings = async () => {
    try {
      const res = await axios.get(
        `${API_URL}/api/follow/list/follower/${username}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
            ...
            >
              ...
              >
                ...
                <div className={`data ${dark ? "setdark" : ""}`}>
                  <ul>
                    {(title === "Following" ? followerList : followingList).map(
                      (user) => (
                        <li
                          key={user._id}
                          className={`${dark ? "setdark" : ""}`}
                              ...
                              <div className="no-posts-container">
                                ...
                                <div className="no-posts-text">
                                  ...
                                  <p className="no-posts-subtext">
                                    When you share photos or videos, they'll
                                    appear here.
                                  </p>
                                </div>
                              </div>
                        ...
                        <div className="private-account-container">
                          ...
                          <div className="private-account-text">
                            ...
                            <p className="private-account-subtext">
                              Follow this account to see their photos and
                              videos.
                            </p>
                          </div>
                          <button
