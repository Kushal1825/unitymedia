...
const sendMessage = asyncHandler(async(req,res)=>{
  ...
  res.status(201)
  .json(new ApiResponse(201,newMessage,"Send Successfully"))
  } catch (error) {
    console.log(error);
    res.status(500)
...
const getMessages = asyncHandler(async (req,res)=>{
  try {
    ...
    res.status(200)
    .json(new ApiResponse(200,messages,"Message is created"));
  } catch (error) {
    console.log(error)
    res.status(500)
...
const getConversation = asyncHandler(async (req,res)=>{
  try {
    ...
    res.status(200)
    .json(new ApiResponse(200,conversation,"Conversation fetch successfully"));
  } catch (error) {
    console.log(error);
    res.status(500)
...
const deleteMessage = asyncHandler(async (req,res)=>{
  try {
    ...
    if(!message){
      return res.status(404)
      .json(new ApiResponse(404,null,"Message is not exists"));
    }
    ...
    if(message.sender.toString() != req.user?._id.toString()){
      ...
      .json(new ApiResponse(401,null,"You cannot delete the message"));
    }
